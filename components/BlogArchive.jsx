...
const BlogArchive = (props) => {
	...
	var [queryPrams, setqueryPrams] = useState(props?.queryPrams ? props?.queryPrams : { category: null, tag: null, keyword: "", paged: 1, order: "DESC", per_page: 18, });
	...
	function fetchPosts() {
		...
		fetch(serverUrl + "wp-json/promptshub/v2/get_posts", {
			method: "POST",
			...
			<div className="bg-[#ffcbb3] text-[#783009] "
				...
				<div className="flex flex-col relative">
					...
					<div className="text-left flex flex-col gap-3 flex-1 p-3">
						<Link className="text-left text-sm lg:text-base  cursor-pointer" href={`/blog/${entry.slug}/`} >{entry?.title}
						</Link>
