...
const ProductGrid = (props) => {
	...
	var [queryPrams, setqueryPrams] = useState(props?.queryPrams ? props?.queryPrams : { categories: categories, category: null, tag: null, keyword: "", paged: 1, order: "DESC", per_page: 10, price: "" });
	...
	function loopLayout(entry, columnIndex) {
		...
		return (
			<div className="bg-[#ffcbb3] text-[#783009] rounded-sm"
				key={columnIndex}>
	...
	return (
		<div className="w-full">
			...
			{entries?.posts.length > 0 && (
				...
				<div className="grid xl:grid-cols-5 grid-cols-2 gap-5">
